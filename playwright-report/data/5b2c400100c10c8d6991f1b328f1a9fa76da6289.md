...
- Name: homepage.spec.ts >> Homepage >> theme toggle works
...
Call log:
  - waiting for getByLabel('Toggle dark mode')
    - locator resolved to <button type="button" id="theme-toggle" data-astro-source-loc="84:8" aria-label="Toggle dark mode" data-astro-source-file="/Users/marco/Documents/AIProjects/Portfolio/portfolio/src/components/layout/Navigation.astro" class="w-[38px] h-[38px] flex items-center justify-center rounded-[10px] border-[1.5px] border-border text-muted transition-all duration-200 hover:text-accent hover:border-accent hover:bg-accent-light">…</button>
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e228]:
    - button "Menu" [ref=e229]:
      - img [ref=e231]
      - generic: Menu
    - button "Inspect" [ref=e235]:
      - img [ref=e237]
      - generic: Inspect
    - button "Audit" [ref=e239]:
      - generic [ref=e240]:
        - img [ref=e241]
        - img [ref=e244]
      - generic: Audit
